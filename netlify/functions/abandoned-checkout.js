...
const T = {
  ar: {
    reminder1: { subject: 'لم تُكمل تسجيلك في أسد الأوبشن ⚜', hi: 'يبدو أنك على وشك الانضمام إلينا',
    ...
    reminder3: { subject: 'انضم لآلاف المتداولين في أسد الأوبشن ⚜', hi: 'أنت على بعد خطوة واحدة',
    ...
    reminder4: { subject: 'آخر تذكير — تسجيلك في أسد الأوبشن ⚜', hi: 'هذا آخر تذكير منّا',
  ...
  en: {
    reminder1: { subject: "You haven't completed your Option Lion registration ⚜", hi: 'Looks like you were about to join us',
    ...
    reminder3: { subject: 'Join thousands of traders on Option Lion ⚜', hi: "You're one step away",
    ...
    reminder4: { subject: 'Last reminder — your Option Lion registration ⚜', hi: 'This is our last reminder',
