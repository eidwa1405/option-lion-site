...
(function(){
  ...
  var STR = {
    ...
    it:{dir:'ltr',title:'Verifica la tua email',sub:'Inserisci il codice a 6 cifre inviato a',btn:'Autentica',verifying:'Verifica in corso…',success:'Verificato con successo',resend:'Non hai ricevuto il codice? Rinvia',resendIn:'Rinvia tra',sec:'s',resending:'Invio…',resent:'Nuovo codice inviato ✓',errInvalid:'Codice non valido, riprova',errIncomplete:'Inserisci tutte le 6 cifre',errNet:'Impossibile contattare il server',close:'Chiudi'},
