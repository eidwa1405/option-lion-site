...
exports.handler = async (event) => {
  ...
  try {
    ...
    const bodyHtml = `<div dir="rtl">مرحباً <b>${a.name}</b> 👋<br><br>تلقّينا طلباً لاستعادة بيانات دخولك كسفير في O P N LIO ⚜<br><br>اسم المستخدم: <b style="color:#D4AF37; font-size:16px;">${a.login_username || a.code}</b><br>كلمة مرورك الجديدة المؤقتة: <b style="color:#D4AF37; font-size:18px;">${tempPassword}</b><br><br>يمكنك استخدامها للدخول عبر <a href="https://opon.netlify.app/affiliate-login.html" style="color:#D4AF37;">affiliate-login</a>، ويُفضّل تغييرها إلى كلمة مرور من اختيارك بعد الدخول من داخل لوحة تحكمك.<br><br>إن لم تكن أنت من طلب ذلك، تواصل مع فريق الدعم فوراً.</div>`;
